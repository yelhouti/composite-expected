...
class WithIdStringDetailsResourceIT {
    ...
    private static final String ENTITY_API_URL = "/api/with-id-string-details";
    ...
    void updateWithIdStringDetailsMapsIdAssociationWithNewId() throws Exception {
        ...
        restWithIdStringDetailsMockMvc
            .perform(
                put(ENTITY_API_URL_ID, updatedWithIdStringDetailsDTO.getId())
                    .contentType(MediaType.APPLICATION_JSON)
    ...
    void getWithIdStringDetails() throws Exception {
        ...
        restWithIdStringDetailsMockMvc
            .perform(get(ENTITY_API_URL_ID, withIdStringDetails.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    void getNonExistingWithIdStringDetails() throws Exception {
        // Get the withIdStringDetails
        restWithIdStringDetailsMockMvc.perform(get(ENTITY_API_URL_ID, Long.MAX_VALUE)).andExpect(status().isNotFound());
    }

    @Test
    @Transactional
    void putNewWithIdStringDetails() throws Exception {
        // Initialize the database
        withIdStringDetailsRepository.saveAndFlush(withIdStringDetails);
    ...
    @Test
    @Transactional
    void putNonExistingWithIdStringDetails() throws Exception {
        int databaseSizeBeforeUpdate = withIdStringDetailsRepository.findAll().size();
    ...
    @Test
    @Transactional
    void putWithIdMismatchWithIdStringDetails() throws Exception {
        int databaseSizeBeforeUpdate = withIdStringDetailsRepository.findAll().size();
        withIdStringDetails.setId(UUID.randomUUID().toString());
    ...
    @Test
    @Transactional
    void putWithMissingIdPathParamWithIdStringDetails() throws Exception {
        int databaseSizeBeforeUpdate = withIdStringDetailsRepository.findAll().size();
        withIdStringDetails.setId(UUID.randomUUID().toString());
    ...
    void deleteWithIdStringDetails() throws Exception {
        ...
        restWithIdStringDetailsMockMvc
            .perform(delete(ENTITY_API_URL_ID, withIdStringDetails.getId()).accept(MediaType.APPLICATION_JSON))
