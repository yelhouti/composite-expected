...
class EmployeeResourceIT {
    ...
    void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc
            .perform(get("/api/employees?sort=username,desc"))
    ...
    void getEmployee() throws Exception {
        ...
        // Get the employee
        restEmployeeMockMvc
            .perform(get("/api/employees/{id}", employee.getUsername()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    private void defaultEmployeeShouldBeFound(String filter) throws Exception {
        restEmployeeMockMvc
            .perform(get("/api/employees?sort=username,desc&" + filter))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].username").value(hasItem(employee.getUsername())))
            .andExpect(jsonPath("$.[*].fullname").value(hasItem(DEFAULT_FULLNAME)));
        ...
        restEmployeeMockMvc
            .perform(get("/api/employees/count?sort=username,desc&" + filter))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    void deleteEmployee() throws Exception {
        ...
        // Delete the employee
        restEmployeeMockMvc
            .perform(delete("/api/employees/{id}", employee.getUsername()).accept(MediaType.APPLICATION_JSON))
