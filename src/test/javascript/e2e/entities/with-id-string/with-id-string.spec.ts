...
describe('WithIdString e2e test', () => {
  ...
  it('should create and save WithIdStrings', async () => {
    ...
    await promise.all([withIdStringUpdatePage.setNameInput('name')]);

    expect(await withIdStringUpdatePage.getNameInput()).to.eq('name', 'Expected Name value to be equals to name');
