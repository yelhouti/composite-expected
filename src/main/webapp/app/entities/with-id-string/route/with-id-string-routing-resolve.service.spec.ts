...
describe('Service Tests', () => {
  describe('WithIdString routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return existing IWithIdString for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new WithIdString(id) })));
        ...
        expect(resultWithIdString).toEqual(new WithIdString('123'));
      });
