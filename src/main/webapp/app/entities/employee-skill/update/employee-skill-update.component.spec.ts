  ...
  describe('EmployeeSkill Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Task query and add missing value', () => {
        const employeeSkill: IEmployeeSkill = { id: 456 };
        const tasks: ITask[] = [{ id: 51961 }];
        employeeSkill.tasks = tasks;

        const taskCollection: ITask[] = [{ id: 45897 }];
      ...
      it('Should call Employee query and add missing value', () => {
        const employeeSkill: IEmployeeSkill = { id: 456 };
        const employee: IEmployee = { username: 'card Steel navigating' };
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        ...
        const employeeSkill = new EmployeeSkill(123);
    ...
    describe('Getting selected relationships', () => {
      describe('getSelectedTask', () => {
        ...
        it('Should return selected Task for according option', () => {
          const option = new Task(123);
          const selected = new Task(123);
          const selected2 = new Task(456);
