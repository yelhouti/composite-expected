  ...
  describe('Employee Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Employee query and add missing value', () => {
        const employee: IEmployee = { username: 'CBA' };
        const manager: IEmployee = { username: 'Account modular Concrete' };
        employee.manager = manager;

        const employeeCollection: IEmployee[] = [{ username: 'Tuna Bedfordshire' }];
      ...
      it('Should update editForm', () => {
        const employee: IEmployee = { username: 'CBA' };
        const manager: IEmployee = { username: 'Tuna' };
        employee.manager = manager;
