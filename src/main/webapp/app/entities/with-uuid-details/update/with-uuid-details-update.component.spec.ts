...
import { IWithUUID, WithUUID } from 'app/entities/with-uuid/with-uuid.model';
  ...
  describe('WithUUIDDetails Management Update Component', () => {
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        ...
        const withUUIDDetails = new WithUUIDDetails('9fec3727-3421-4967-b213-ba36557ca194');
    ...
    describe('Tracking relationships identifiers', () => {
      describe('trackWithUUIDByUuid', () => {
        it('Should return tracked WithUUID primary key', () => {
          const entity = new WithUUID('9fec3727-3421-4967-b213-ba36557ca194');
