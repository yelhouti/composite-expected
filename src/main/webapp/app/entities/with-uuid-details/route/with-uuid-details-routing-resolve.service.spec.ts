...
describe('Service Tests', () => {
  describe('WithUUIDDetails routing resolve service', () => {
    ...
    describe('resolve', () => {
      it('should return existing IWithUUIDDetails for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new WithUUIDDetails(id) })));
        ...
        expect(resultWithUUIDDetails).toEqual(new WithUUIDDetails('9fec3727-3421-4967-b213-ba36557ca194'));
      });
