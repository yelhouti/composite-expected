...
import { ICertificateType, CertificateType } from 'app/entities/certificate-type/certificate-type.model';
import { CertificateTypeService } from 'app/entities/certificate-type/service/certificate-type.service';
import { IEmployeeSkill, EmployeeSkill } from 'app/entities/employee-skill/employee-skill.model';
  ...
  describe('EmployeeSkillCertificate Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      ...
      it('Should call EmployeeSkill query and add missing value', () => {
        const employeeSkillCertificate: IEmployeeSkillCertificate = { id: 456 };
        const skill: IEmployeeSkill = { id: 513 };
        employeeSkillCertificate.skill = skill;

        const employeeSkillCollection: IEmployeeSkill[] = [{ id: 3662 }];
      ...
      it('Should update editForm', () => {
        const employeeSkillCertificate: IEmployeeSkillCertificate = { id: 456 };
        const type: ICertificateType = { id: 66149 };
        employeeSkillCertificate.type = type;
        const skill: IEmployeeSkill = { id: 94063 };
        employeeSkillCertificate.skill = skill;
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        ...
        const employeeSkillCertificate = new EmployeeSkillCertificate(123);
    ...
    describe('Tracking relationships identifiers', () => {
      ...
      describe('trackEmployeeSkillById', () => {
        it('Should return tracked EmployeeSkill primary key', () => {
          const entity = new EmployeeSkill(123);
          const trackResult = comp.trackEmployeeSkillById(0, entity);
          expect(trackResult).toEqual(entity.id);
        });
      });
    });
