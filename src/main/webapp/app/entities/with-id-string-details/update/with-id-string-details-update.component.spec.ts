...
import { IWithIdString, WithIdString } from 'app/entities/with-id-string/with-id-string.model';
  ...
  describe('WithIdStringDetails Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call withIdString query and add missing value', () => {
        const withIdStringDetails: IWithIdStringDetails = { id: '456' };
    ...
    describe('save', () => {
      it('Should call update service on save for existing entity', () => {
        ...
        const withIdStringDetails = new WithIdStringDetails('123');
