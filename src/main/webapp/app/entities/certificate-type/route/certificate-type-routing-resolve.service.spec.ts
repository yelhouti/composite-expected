...
describe('Service Tests', () => {
  describe('CertificateType routing resolve service', () => {
    ...
    let resultCertificateType: ICertificateType | undefined;
    ...
    describe('resolve', () => {
      it('should return existing ICertificateType for existing id', () => {
        // GIVEN
        service.find = jest.fn(id => of(new HttpResponse({ body: new CertificateType(id) })));
        ...
        expect(resultCertificateType).toEqual(new CertificateType(123));
      });

      it('should return new ICertificateType if id is not provided', () => {
        // GIVEN
        ...
        expect(resultCertificateType).toEqual(new CertificateType());
      });
