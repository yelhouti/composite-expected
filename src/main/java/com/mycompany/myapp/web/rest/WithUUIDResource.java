...
public class WithUUIDResource {
    ...
    public WithUUIDResource(WithUUIDService withUUIDService, WithUUIDQueryService withUUIDQueryService) {
    ...
    /**
     * {@code PUT  /with-uuids} : Updates an existing withUUID.
     *
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/with-uuids")
    public ResponseEntity<WithUUIDDTO> updateWithUUID(@Valid @RequestBody WithUUIDDTO withUUIDDTO) throws URISyntaxException {
        log.debug("REST request to update WithUUID : {}", withUUIDDTO);
        if (withUUIDDTO.getUuid() == null) {
