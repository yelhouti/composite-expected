...
public class CertificateTypeResource {
    ...
    public ResponseEntity<CertificateTypeDTO> updateCertificateType(@Valid @RequestBody CertificateTypeDTO certificateTypeDTO)
        throws URISyntaxException {
    ...
    public ResponseEntity<CertificateTypeDTO> partialUpdateCertificateType(@NotNull @RequestBody CertificateTypeDTO certificateTypeDTO)
        ...
        Optional<CertificateTypeDTO> result = Optional.ofNullable(certificateTypeService.partialUpdate(certificateTypeDTO));
