...
public class WithUUIDDetailsResource {
    ...
    public WithUUIDDetailsResource(WithUUIDDetailsService withUUIDDetailsService, WithUUIDDetailsQueryService withUUIDDetailsQueryService) {
    ...
    /**
     * {@code PUT  /with-uuid-details} : Updates an existing withUUIDDetails.
     *
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/with-uuid-details")
    public ResponseEntity<WithUUIDDetailsDTO> updateWithUUIDDetails(@RequestBody WithUUIDDetailsDTO withUUIDDetailsDTO)
        throws URISyntaxException {
        log.debug("REST request to update WithUUIDDetails : {}", withUUIDDetailsDTO);
        if (withUUIDDetailsDTO.getUuid() == null) {
